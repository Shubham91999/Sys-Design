...
class Board:
    def __init__(self):
        self.board = [[None] * 8 for _ in range(8)]  # Creates an 8x8 grid initialized with None
        self._initialize_board()  # To populate pieces in their standard positions.
    ...
    def is_valid_move(self, piece, dest_row, dest_col):
        ...
        return (dest_piece is None or dest_piece.color != piece.color) and piece.canMove(self, dest_row, dest_col)
